...
# This script can be used in conjunction with a VPN to ensure protection for every network interface. If the script does not work or you prefer not to use it, you have the option of blocking incoming port 6672 for all 
